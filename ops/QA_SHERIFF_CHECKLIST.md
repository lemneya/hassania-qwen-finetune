...
## Auto-Claude PR Quick Checks

- [ ] PR includes "Risk Level: L0/L1/L2/L3"
- [ ] Evidence section contains real output (logs/tests/repro steps)
- [ ] Scope matches the Gate file (no extra features)
- [ ] If sensitive paths touched:
  - [ ] Two-Key rule satisfied
  - [ ] For L2/L3: Spec PR existed and was approved before Build PR
- [ ] If conflicts were resolved:
  - [ ] Human reviewed the resolution (especially L2/L3)
